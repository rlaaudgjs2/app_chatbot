...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            left_chat_view = itemView.findViewById(R.id.left_chat);
            right_chat_view = itemView.findViewById(R.id.right_chat);
            left_chat_tv = itemView.findViewById(R.id.left_chat_text);
            right_chat_tv = itemView.findViewById(R.id.right_chat_text);
        }
    }
}